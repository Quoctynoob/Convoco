    ...
    <div className="space-y-16">
      ...
      <div className="text-center py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div className="mt-10 flex justify-center gap-4">
          <Link href="/debates">
            <Button size="lg">Browse Debates</Button>
          </Link>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              <div className="text-center">
                <div className="flex items-center justify-center mx-auto h-16 w-16 rounded-full bg-purple-100 text-purple-900 text-2xl font-bold">
                  1
                </div>
                ...
                <p className="mt-2 text-base text-gray-500">
                  Select from trending debate topics or create your own. Add it
                  to your profile to attract opponents.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="mt-2 text-base text-gray-500">
                  After all rounds, Gemini AI provides an impartial judgment and
      ...
      <div className="bg-purple-600 rounded-xl">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
            <span className="block">Ready to sharpen your debate skills?</span>
            <span className="block">Start a debate today.</span>
          </h2>
